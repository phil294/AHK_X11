...
+ FileRecycleEmpty, SplitPath, StringSplit, Transform

NEW       7% (15/226): (not part of spec or from a more recent version)
...
@@ #DefineCommand, DllCall, VarSetCapacity, NumGet, NumPut @@
...
TO DO     31% (70/226): alphabetically
...
- StringCaseSense, SysGet, Thread, WinActivateBottom, WinGetActiveStats, WinGetActiveTitle,
