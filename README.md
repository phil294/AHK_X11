...
- DetectHiddenText, DetectHiddenWindows, Drive, DriveGet, DriveSpaceFree, Edit, EnvDiv, 
- EnvMult, EnvSub, FileAppend, FileCopyDir, FileCreateDir, FileCreateShortcut, FileDelete, 
