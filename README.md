...
+ WinGetTitle, WinGetClass, PixelGetColor, CoordMode, GuiControl, ControlGetPos
...
TO DO     ?% (111/217): alphabetically
- BlockInput, ClipWait, Control, ControlFocus, ControlGet, ControlGetFocus, 
- ControlGetText, ControlMove, ControlSetText,
...
- WinGetActiveStats, WinGetActiveTitle, WinGet,
