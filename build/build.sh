...
./linuxdeploy-x86_64.AppImage --appdir AppDir --output appimage --desktop-file ../assets/ahk_x11.desktop --icon-file ../assets/ahk_x11.png --executable ../bin/ahk_x11 --library ./libxdo.so.3 --plugin gtk
rm -rf AppDir

mv ahk_x11-x86_64.AppImage ahk_x11.AppImage
...
cp ahk_x11.AppImage ahk_x11_pre_installer.AppImage
./ahk_x11.AppImage --compile ../src/installer.ahk tmp && mv tmp ahk_x11.AppImage

echo 'bump shard version'